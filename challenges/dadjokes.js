...
function dadJokes() {
 ...
 fetch('https://dad-jokes.p.rapidapi.com/random/joke', {
    ...
    headers : {
    "x-rapidapi-key": "894dd9d2a9mshc076e5c81b0afd1p14164ejsnf67e35b7e0c4",
	"x-rapidapi-host": "dad-jokes.p.rapidapi.com",
	"useQueryString": true
    }
 }).then((data) => data.json())
 .then(data => fetchFunction(data))
  ...
  function fetchFunction(data) {
    ...
    // let newPTag = document.createElement('p')   // If you want to create
    // console.log(newPTag)                        // a new element/ second title
    //newPTag.innerText = 'second title'
    //title.appendChild(newPTag)
        console.log(data)
